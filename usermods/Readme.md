...
| --- | --- | --- | --- | --- |
| TheWarolf | [AB Toolhead Sensor](./AB_Toolhead_Sensor) | Making the standard AB clockwork "smart" by inserting filament sensors in the toolhead. Uses microswitch + 7mm steel ball combo. | :heavy_check_mark: | :x: |
